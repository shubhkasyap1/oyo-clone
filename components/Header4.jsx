...
const Header4 = () => {
  return (
    <div className="flex justify-between items-center my-14 border-2 rounded-lg border-gray-300 px-5 py-2">
      ...
      <div className="flex">
        <input type="email" className="px-6 py-3 rounded-lg mr-5 w-80 h-16 outline-none border border-gray-300"
            placeholder="e.g. jhon@gmail.com"
        />
        <button type="submit" className="w-48 rounded-lg bg-red-500 text-xl text-white cursor-pointer">Notify Me</button>
      </div>
    </div>
  );
};
